...
public class BatteryReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        TextView statusLabel = (context(MainActivity)).findViewById(R.id.statusLabel);
        TextView percentageLabel = (context(MainActivity)).findViewById(R.id.percentageLabel);
        ImageView batteryImage = (context(MainActivity)).findViewById(R.id.batteryImage);
